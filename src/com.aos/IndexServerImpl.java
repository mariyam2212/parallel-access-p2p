...
public class IndexServerImpl implements IndexServerInterface {
    ...
    @Override
    public synchronized void registryFiles(String rd, String filename, String peerid, String port_num, String directory, long fileSize) throws RemoteException {
        ...
        if (rd.equalsIgnoreCase("new")) {
            ...
            arrFileDtl.add(String.valueOf(fileSize));
